...
import com.sqliteCtrl.Annotation.TableName;
import com.sqliteCtrl.Annotation.TableProperty;
import com.sqliteCtrl.util.DataBase;
import com.sqliteCtrl.util.Xml2Data;
...
public class Database2Pojo {
	 ...
	 */
	public Database2Pojo(Context context, Integer database) throws XmlPullParserException, IOException {
		this.context = context;
		// 连接数据库数据库
		DataBase dbBase = new DataBase(context, database);
		// 初始化连接
	 ...
	 * @throws XmlPullParserException
	 */
	public Database2Pojo(Context context, Integer database, int version) throws XmlPullParserException, IOException {
		this.context = context;
		// 连接数据库数据库
